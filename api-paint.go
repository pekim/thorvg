...
func (paint paintCommon) paint() C.Tvg_Paint {
	return paint.paint_
}
...
func (paint paintCommon) Rel() error {
	result := C.tvg_paint_rel(paint.paint_)
...
func (paint paintCommon) Ref() int {
	return int(C.tvg_paint_ref(paint.paint_))
}
...
func (paint paintCommon) Unref(free bool) int {
	return int(C.tvg_paint_unref(paint.paint_, C.bool(free)))
}
...
func (paint paintCommon) GetRef() int {
	return int(C.tvg_paint_get_ref(paint.paint_))
}
...
func (paint paintCommon) SetVisible(visible bool) error {
	result := C.tvg_paint_set_visible(paint.paint_, C.bool(visible))
	return resultError(result)
}
...
func (paint paintCommon) GetVisible() bool {
	return bool(C.tvg_paint_get_visible(paint.paint_))
}
...
func (paint paintCommon) Scale(factor float32) error {
	result := C.tvg_paint_scale(paint.paint_, C.float(factor))
	return resultError(result)
}
...
func (paint paintCommon) Rotate(degree float32) error {
	result := C.tvg_paint_rotate(paint.paint_, C.float(degree))
	return resultError(result)
}
...
func (paint paintCommon) Translate(x float32, y float32) error {
	result := C.tvg_paint_translate(paint.paint_, C.float(x), C.float(y))
	return resultError(result)
}
...
func (paint paintCommon) SetTransform(matrix Matrix) error {
	result := C.tvg_paint_set_transform(paint.paint_, (*C.Tvg_Matrix)(unsafe.Pointer(&matrix)))
	return resultError(result)
}
...
func (paint paintCommon) Ret_transform() (Matrix, error) {
	var matrix Matrix
	result := C.tvg_paint_get_transform(paint.paint_, (*C.Tvg_Matrix)(unsafe.Pointer(&matrix)))
	return matrix, resultError(result)
}
...
func (paint paintCommon) SetOpacity(opacity uint8) error {
	result := C.tvg_paint_set_opacity(paint.paint_, C.uint8_t(opacity))
	return resultError(result)
}
...
func (paint paintCommon) GetOpacity() (uint8, error) {
	var opacity uint8
	result := C.tvg_paint_get_opacity(paint.paint_, (*C.uint8_t)(unsafe.Pointer(&opacity)))
	return opacity, resultError(result)
}
...
func (paint paintCommon) duplicate() paintCommon {
	return paintCommon{
		paint_: C.tvg_paint_duplicate(paint.paint_),
	}
}
...
func (paint paintCommon) Intersects(x int, y int, width int, height int) bool {
	b := C.tvg_paint_intersects(paint.paint_, C.int32_t(x), C.int32_t(y), C.int32_t(width), C.int32_t(height))
	return bool(b)
}
...
func (paint paintCommon) GetAABB() (float32, float32, float32, float32, error) {
	...
	result := C.tvg_paint_get_aabb(paint.paint_, &x, &y, &width, &height)
	return float32(x), float32(y), float32(width), float32(height), resultError(result)
}
...
func (paint paintCommon) GetOBB() ([4]Point, error) {
	var points [4]Point
	result := C.tvg_paint_get_obb(paint.paint_, (*C.Tvg_Point)(unsafe.Pointer(&points[0])))
	return points, resultError(result)
}
...
func (paint paintCommon) SetMaskMethod(target Paint, method MaskMethod) error {
	result := C.tvg_paint_set_mask_method(paint.paint_, target.paint(), *(*C.Tvg_Mask_Method)(unsafe.Pointer(&method)))
	return resultError(result)
}
...
func (paint paintCommon) GetMaskMethod(target Paint) (MaskMethod, error) {
	var method C.Tvg_Mask_Method
	result := C.tvg_paint_get_mask_method(paint.paint_, target.paint(), &method)
	return *(*MaskMethod)(unsafe.Pointer(&method)), resultError(result)
}
...
func (paint paintCommon) SetClip(clipper Paint) error {
	result := C.tvg_paint_set_clip(paint.paint_, clipper.paint())
	return resultError(result)
}
...
This function returns the clipper that has been previously set to this paint object.
	...
	@since 1.0
*/
func (paint paintCommon) GetClip() (Paint, bool) {
	clipper := C.tvg_paint_get_clip(paint.paint_)
	if clipper == nil {
		return nil, false
	}
...
func (paint paintCommon) GetType() (Type, error) {
	var typ C.Tvg_Type
	result := C.tvg_paint_get_type(paint.paint_, &typ)
	return *(*Type)(unsafe.Pointer(&typ)), resultError(result)
}
...
func (paint paintCommon) SetBlendMethod(method BlendMethod) error {
	result := C.tvg_paint_set_blend_method(paint.paint_, *(*C.Tvg_Blend_Method)(unsafe.Pointer(&method)))
	return resultError(result)
}

func newPaint(paint C.Tvg_Paint) (Paint, bool) {
	var typ Type
	result := C.tvg_paint_get_type(paint, (*C.Tvg_Type)(unsafe.Pointer(&typ)))
